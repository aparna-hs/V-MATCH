...
{
var pno=/^\d{10}$/;
var it=document.getElementById("usrtel");
if(!it.value.match(pno))
{
...
-->
		...
		<tr>
		 ...
		 <tr>
			...
			<td><input type="text" name="country" id="country" onclick="chkindian()" class="box" size="50" maxlength="20" placeholder="--NA--" > </td>
		</tr>
		 ...
		 <tr>
			<td>State:* </td>
			<td><select  id="state" name="state" style="width: 300px;"  selected=" " required >
